...
namespace MexicoTaxReport.Handlers
{
	public partial class BlobFactory
    {
        ...
        static BlobFactory()
        {
            ...
            RegisterHandler("InvoiceTaxReportPdf", "\"dbo\".\"InvoiceTaxReport\"", "\"Pdf\"", new string[] {
                        "\"ID\""}, "Invoice Tax Report Pdf", "InvoiceTaxReport", "Pdf");
        }
    }
...
function UploadSuccess(key, message) { 
    ...
    public class BlobAdapter
    {
        ...
        public static string ValidationKey
        {
            get
            {
                return "4DF3FD3B9E7E4F4A6F516CE304616682D2CA6072D40301A056220E8FE84F5D0E622B5AEAE513FD7E8" +
                    "12E0B7CF3876383A672BBA1474A2DA8B8A6BF72C5E57600";
            }
        }
