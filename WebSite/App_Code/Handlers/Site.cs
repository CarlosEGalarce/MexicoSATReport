...
namespace MexicoTaxReport.Handlers
{
    ...
    public class SiteBase : MexicoTaxReport.Web.PageBase
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (_isTouchUI)
            {
                if (_pageFooterContent != null)
                	_pageFooterContent.Text = "<footer style=\"display:none\"><small>&copy; 2016 MexicoTaxReport. ^Copyright^All r" +
                        "ights reserved.^Copyright^</small></footer>";
            }
            else
        ...
        protected virtual void InitializeSiteMaster()
        {
            ...
            string themePath = Server.MapPath("~/App_Themes/MexicoTaxReport");
            if (Directory.Exists(themePath))
            	foreach (string stylesheetFileName in Directory.GetFiles(themePath, "*.css"))
                {
                    ...
                    if (!(fileName.Equals("_Theme_DarkKnight.css")))
                    {
                        ...
                        link.Href = ("~/App_Themes/MexicoTaxReport/" + fileName);
